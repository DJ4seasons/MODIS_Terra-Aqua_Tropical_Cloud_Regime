...
###-------------------------------------
dir1 = './Data/'
ctdfnm = 'Centroid.MODIS_T+A_b42_DTR_CR10.subCR{}'.format(nk)
...
plt.suptitle("MODIS C6 T+A Tropical CR: TCR10 Sub-CRs",fontsize=20,y=0.98)
...
for ii in range(nk):
    ...
    subtit= "CR10{}. CF={:.1f}%".format(abc[ii],obscf[ii])
    if ii%3==0:
        ylpos='left'
    elif ii%3==2:
        ylpos='right'
